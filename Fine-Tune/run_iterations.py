...
class Run_Iterations(object):
    def __init__(self, model, train_in_seq, train_out_seq, train_input_lengths,
                 train_speakers, train_addressees, index2word, batch_size, num_iters,
                 learning_rate, tracking_pair=False, dev_in_seq=[], dev_out_seq=[],
                 dev_input_lengths=[], dev_speakers=[], dev_addressees=[],
        ...
        self.dev_speakers = dev_speakers
        self.dev_addressees = dev_addressees
